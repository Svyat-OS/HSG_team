...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_reg_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_reg_t qt_meta_stringdata_reg = {
    {
        QT_MOC_LITERAL(0, 3),  // "reg"
        QT_MOC_LITERAL(4, 21),  // "on_pushButton_clicked"
        QT_MOC_LITERAL(26, 0),  // ""
        QT_MOC_LITERAL(27, 23)   // "on_pushButton_2_clicked"
    },
    "reg",
...
Q_CONSTINIT static const uint qt_meta_data_reg[] = {
...
Q_CONSTINIT const QMetaObject reg::staticMetaObject = { {
    ...
    qt_meta_stringdata_reg.offsetsAndSizes,
    qt_meta_data_reg,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_reg_t,
        // Q_OBJECT / Q_GADGET
