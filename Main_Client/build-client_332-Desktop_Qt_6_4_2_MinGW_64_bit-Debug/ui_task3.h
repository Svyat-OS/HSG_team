...
public:
    ...
    void setupUi(QWidget *task3)
    {
        ...
        pushButton->setGeometry(QRect(90, 20, 221, 61));
        label = new QLabel(task3);
        label->setObjectName("label");
        label->setGeometry(QRect(20, 140, 101, 21));
        lineEdit = new QLineEdit(task3);
        lineEdit->setObjectName("lineEdit");
        lineEdit->setGeometry(QRect(250, 140, 113, 20));
        pushButton_2 = new QPushButton(task3);
        pushButton_2->setObjectName("pushButton_2");
        pushButton_2->setGeometry(QRect(10, 207, 80, 31));
        pushButton_3 = new QPushButton(task3);
        pushButton_3->setObjectName("pushButton_3");
        pushButton_3->setGeometry(QRect(250, 207, 121, 31));
